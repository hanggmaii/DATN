import 'package:datn/language/vi_strings.dart';
...
class TranslationConstants {
  ...
  static String goPremium = 'goPremium';
  static String watchingAds = 'watchingAds';
  ...
  static final List<String> bloodSugarNotiMsgs = List<String>.generate(10, (index) => "bloodSugarNoti$index", growable: false);
  static final List<String> weightAndBMINotiMsgs = List<String>.generate(10, (index) => "bloodSugarNoti$index", growable: false);
  ...
  static String perMonth = "perMonth";
