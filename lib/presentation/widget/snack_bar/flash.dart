...
class _FlashState<T> extends State<Flash<T>> {
  ...
  HorizontalDismissDirection? get horizontalDismissDirection => widget.horizontalDismissDirection;
  ...
  bool get hasBarrier => widget.barrierBlur != null || widget.barrierColor != null;
  ...
  bool get _shouldIgnoreFocusRequest {
    return animationController.status == AnimationStatus.reverse || (controller.route?.navigator?.userGestureInProgress ?? false);
  }
    ...
    if (widget.alignment == null) {
      ...
      child = SlideTransition(
        ...
        child: FadeTransition(
          opacity: animationController.drive(Tween<double>(begin: 0.0, end: 1.0)),
          child: child,
        ),
      );
    }
            ...
            AnimatedBuilder(
              ...
              builder: (context, child) {
                ...
                return GestureDetector(
                  ...
                  onTap: widget.barrierDismissible ? () => controller.dismiss() : null,
                  child: child,
                );
              },
            ),
  ...
  void _handleHorizontalDragUpdate(DragUpdateDetails details) {
    ...
    switch (horizontalDismissDirection) {
      ...
      case HorizontalDismissDirection.startToEnd:
        ...
        break;
      default:
        throw ArgumentError('Direction $horizontalDismissDirection not supported');
    }
